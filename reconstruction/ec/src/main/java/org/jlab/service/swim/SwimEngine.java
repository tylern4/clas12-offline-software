...
public class SwimEngine extends ReconstructionEngine {
    ...
    public SwimEngine(){
        ...
        LOGGER.debug("[swimmer] ----> constructor initialization");
    }
    ...
    private void test_caching_index(){
        ...
        for(int i = 0; i < 350000; i++){
            ...
            */
            //LOGGER.debug("index = " + index_x + " " + index_y + " " + index_z);
    ...
    @Override
    public boolean init() {
        LOGGER.debug("[swimmer] -------> ****** swimmer initialization ******");
        //this.initField();
        //this.initMagField();
        fastMC = new Clas12FastMC(-1.0,1.0);
        //MagneticField.setMathLib(MagneticField.MathLib.FAST);
        //LOGGER.debug("[swimmer] -------> FAST MONTE CARLO TEST. USING FAST MATH = " + MagneticField.MathLib.SUPERFAST);
        return true;
    }
    ...
    private synchronized void initMagField(){
        ...
        magfield.add(mf);
        //LOGGER.debug(" MAGNETIC FIELD CAPACITY = " + mf.getBuffer().capacity());
    }
    ...
    private synchronized void initField(){
        if(field.isEmpty()){
         ...
         field.add(compositeField);
            ...
            LOGGER.debug("[swimmer] ---> there is no reason to load the field");
        }

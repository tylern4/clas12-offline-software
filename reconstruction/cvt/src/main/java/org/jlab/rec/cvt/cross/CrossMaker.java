...
public class CrossMaker {
	...
	private ArrayList<Cross> findBMTCrosses(
		...
		for(Cluster Zlayerclus : Zlayrclus){	
			...
			double x0 = (org.jlab.rec.cvt.bmt.Constants.getCRZRADIUS()[Zlayerclus.get_Region()-1]+org.jlab.rec.cvt.bmt.Constants.LYRTHICKN)*Math.cos(Zlayerclus.get_Phi0());
			double y0 = (org.jlab.rec.cvt.bmt.Constants.getCRZRADIUS()[Zlayerclus.get_Region()-1]+org.jlab.rec.cvt.bmt.Constants.LYRTHICKN)*Math.sin(Zlayerclus.get_Phi0());
			...
			double x = (org.jlab.rec.cvt.bmt.Constants.getCRZRADIUS()[Zlayerclus.get_Region()-1]+org.jlab.rec.cvt.bmt.Constants.LYRTHICKN)*Math.cos(Zlayerclus.get_Phi());
			double y = (org.jlab.rec.cvt.bmt.Constants.getCRZRADIUS()[Zlayerclus.get_Region()-1]+org.jlab.rec.cvt.bmt.Constants.LYRTHICKN)*Math.sin(Zlayerclus.get_Phi());
